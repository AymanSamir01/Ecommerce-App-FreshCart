            ...
            <div className=" w-100 d-flex justify-content-between align-items-center flex-wrap">
              <div>
                ...
                cartDetails === undefined ? (
                  <h5 className="text-center text-main">your cart is empty</h5>
                ) : (
                  <>
                    <h4 className="h6  fw-semibold text-main">
                      Number Of Products : {cartDetails?.numOfCartItems}
                    </h4>
                    <h4 className="h6 fw-semibold text-main">
              ...
              cartDetails === undefined ? (
                ...
                <div className="btnPayment">
                  ...
                  <button className="btn w-100 d-block mb-1 bg-main text-white">
                    Cash On Delivery
                  </button>
                </div>
              )}
